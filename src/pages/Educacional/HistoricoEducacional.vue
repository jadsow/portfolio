<template>
  <q-page class="flex column">
    <div class="row q-col-gutter-sm">
      ...
      >
        <span class="text-bold" style="font-size: 2em">
          {{ i.instituicao }}
        </span>
        <span style="font-size: 20px"> {{ i.curso }} </span>
        <span style="font-size: 20px" class="text-bold text-italic">
          {{ i.premio }}
        </span>
      </div>
