...
const historico = [
  ...
  },
  {
    empresa:
      "FAPESC - Fundação de Amparo à Pesquisa e Inovação do Estado de Santa Catarina",
    funcao: "Estágio no setor de Gerência e Inovação",
  },
  {
  ...
  {
    empresa: "Produza SA - 2013",
    funcao: "Estágio na área de testes de placas eletrônicas",
  },
];
</script>
<style></style>
